var store = [{
        ...
        "title": "나는",
        "excerpt":"나는 학습에서 개발로 이어지는 재미가, 몰입으로 이어진 순간 it분야로 가고 싶다는 생각으로 대학에 편입한 후, 학부생활속에서는 고민을 가진 채로, 속한 환경 속에서 흘러가는 시간을 보냈었다. 42SEOUL 을 알게 되었고 홈페이지에서 소개하듯이 “소프트웨어에 대한 경험을 나누는 방법, 멋진 동료와 협업하는 방법, 누군가를 위해 본인의 경험을 공유하는 방법을 배웁니다. 그리고 배우는 방법을...","categories": [],
        "tags": [],
        "url": "/%EB%82%98%EB%8A%94/",
        "teaser": null
      }]
